...
// ============================================
const cuento = [
    { parte: "PARTE 1", texto: "EN UNA PEQUEÑA Y ACOGEDORA CASITA EN EL CORAZÓN DEL BOSQUE, VIVÍA UNA DULCE NIÑA MUY QUERIDA POR TODOS." },
    { parte: "PARTE 1-1", texto: "SU MADRE LA AMABA PROFUNDAMENTE Y SIEMPRE SE PREOCUPABA PORQUE ESTUVIERA FELIZ Y BIEN CUIDADA." },
    { parte: "PARTE 2", texto: "TODOS LA CONOCÍAN PORQUE SIEMPRE LLEVABA PUESTA UNA HERMOSA CAPUCHITA DE COLOR ROJO." },
    { parte: "PARTE 2-2", texto: "ESA CAPUCHITA SE LA HABÍA REGALADO SU ABUELA CON MUCHO AMOR, Y ELLA NUNCA SE LA QUITABA." },
    { parte: "PARTE 3", texto: "CAPERUCITA ROJA ERA UNA NIÑA MUY FELIZ Y AMABLE. LE ENCANTABA PASAR SUS TARDES EN LA NATURALEZA." },
    { parte: "PARTE 3-3", texto: "DISFRUTABA MUCHO CORRIENDO ENTRE LOS ÁRBOLES Y JUGANDO ALEGREMENTE CON TODOS LOS ANIMALITOS DEL BOSQUE." },
    { parte: "PARTE 4", texto: "UN DÍA SOLEADO, SU MADRE LE PIDIÓ UN GRAN FAVOR: LLEVAR UNA CANASTA CON PAN, MIEL Y FRUTAS FRESCAS." },
    { parte: "PARTE 4-4", texto: "ESTOS DELICIOSOS ALIMENTOS ERAN PARA SU QUERIDA ABUELITA QUE VIVÍA AL OTRO LADO DEL BOSQUE Y ESTABA ENFERMA." },
    { parte: "PARTE 5", texto: "ANTES DE SALIR, SU MADRE LE ADVIRTIÓ MUY SERIAMENTE QUE NO SE DISTRAJERA DEL CAMINO PRINCIPAL." },
    { parte: "PARTE 5-5", texto: "LE PIDIÓ QUE FUERA DIRECTAMENTE Y QUE NUNCA HABLARA CON NINGÚN EXTRAÑO QUE PUDIERA ENCONTRAR EN EL BOSQUE." },
    { parte: "PARTE 6", texto: "SIN EMBARGO, MIENTRAS CAPERUCITA RECOGÍA ALGUNAS HERMOSAS FLORES PARA ALEGRAR A SU ABUELA, SE DISTRAJO." },
    { parte: "PARTE 6-6", texto: "DE PRONTO, UN LOBO GRANDE Y ASTUTO APARECIÓ SILENCIOSAMENTE ENTRE LOS ÁRBOLES, OBSERVÁNDOLA DETENIDAMENTE." },
    { parte: "PARTE 7", texto: "EL LOBO LA OBSERVABA CON UNA SONRISA ENGAÑOSA MIENTRAS SE ACERCABA A HABLAR CON ELLA LENTAMENTE." },
    { parte: "PARTE 7-7", texto: "MIENTRAS TANTO, ÉL YA TRAMABA UN MALVADO PLAN PARA ENGAÑARLA Y LLEGAR ANTES A LA CASA DE LA ABUELITA." },
    { parte: "FINAL", texto: "POR SUERTE, UN VALIENTE CAZADOR QUE PASABA CERCA ESCUCHÓ LOS GRITOS Y ENTRÓ RÁPIDAMENTE A LA CASA." },
    { parte: "FINAL-2", texto: "ASÍ RESCATÓ A CAPERUCITA Y A SU ABUELA DEL LOBO, Y TODOS VIVIERON MUY FELICES PARA SIEMPRE." }
];
...
function construirLibro() {
    ...
    let html = `
        <div class="page page-cover page-cover-top" data-density="hard">
            <div class="page-content" style="margin: 0; width: 100%; height: 100%; padding: 0; position: relative; overflow: hidden;">
                <img src="/static/inicio_sesion/img/portada.png" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: fill; transform: scale(1.3);">
                <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 1; display: flex; justify-content: center; align-items: flex-start; background: rgba(0,0,0,0.2); padding-top: 20px;">
                    <h1 style="font-family: 'MedievalSharp', cursive; font-size: 65px; color: #f0d06f; text-shadow: 3px 3px 15px rgba(0,0,0,0.9); text-align: center;">Caperucita Roja</h1>
                </div>
            </div>
        </div>
        <div class="page page-cover-inside" data-density="hard">
            <div class="page-content" style="padding: 0; width: 100%; height: 100%;">
                <img src="/static/inicio_sesion/img/caperu.png" style="width: 100%; height: 100%; object-fit: fill;">
            </div>
        </div>
        <div class="page">
            <div class="page-content text-page" style="justify-content: center; align-items: center;">
                <h1 style="font-size: 60px; font-family: 'MedievalSharp', cursive; color: #7b1113; text-align: center;">Caperucita Roja</h1>
            </div>
        </div>
    `;
    ...
    cuento.forEach((item, index) => {
        let imgNum;
        if (index <= 3) imgNum = 1;
        else if (index <= 5) imgNum = 2;
        else if (index <= 7) imgNum = 3;
        else if (index <= 9) imgNum = 4;
        else if (index <= 13) imgNum = 5;
        else imgNum = 'final';
        html += `
            <div class="page">
                <div class="page-content" style="padding: 0; width: 100%; height: 100%;">
                    <img src="/static/inicio_sesion/img/caperu${imgNum}.png" style="width: 100%; height: 100%; object-fit: fill;">
                </div>
            </div>
            <div class="page">
    ...
    html += `
        <div class="page page-cover-inside" data-density="hard">
            <div class="page-content" style="padding: 0; width: 100%; height: 100%;">
                <img src="/static/inicio_sesion/img/caperupersonales.png" style="width: 100%; height: 100%; object-fit: fill;">
            </div>
        </div>
        <div class="page">
            <div class="page-content text-page" style="justify-content: center; align-items: center; padding: 100px;">
                ...
                <p style="font-size: 24px; text-align: center; font-style: italic;">"Escucha siempre los consejos de quienes te aman y camina por la senda segura."</p>
            </div>
        </div>
        <div class="page page-cover page-cover-bottom" data-density="hard">
            <div class="page-content" style="margin: 0; width: 100%; height: 100%; padding: 0; position: relative; overflow: hidden;">
                <img src="/static/inicio_sesion/img/portada_fin.png" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: fill; transform: scale(1.3);">
...
function mostrarAhorcado(pageIndex = null) {
    ...
    const pregCuentos = {
        12: [
            { p: "¿De qué color era la capuchita de la niña?", r: "ROJO" },
            { p: "¿Quién le había regalado la hermosa capuchita?", r: "ABUELA" },
            { p: "¿En dónde vivía la niña con su madre?", r: "BOSQUE" },
            { p: "¿Con quiénes le encantaba jugar en la naturaleza?", r: "ANIMALES" }
        ],
        24: [
            { p: "¿Qué llevaba la niña en su pequeña canasta?", r: "MIEL" },
            { p: "¿Con quién le dijo su madre que no hablara?", r: "EXTRAÑO" },
            { p: "¿Qué recogía la niña cuando se distrajo?", r: "FLORES" },
            { p: "¿Qué animal grande y astuto apareció de pronto?", r: "LOBO" }
        ],
        32: [
            { p: "¿Quién escuchó los gritos en la casa?", r: "CAZADOR" },
            { p: "¿A quién rescató el valiente hombre?", r: "CAPERUCITA" },
            { p: "¿Cómo vivieron todos después del rescate?", r: "FELICES" },
            { p: "¿Quién entró rápidamente a la casa para ayudar?", r: "VALIENTE" }
        ]
    };
